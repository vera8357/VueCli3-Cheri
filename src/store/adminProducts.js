...
export default {
  ...
  actions: {
    getProducts (context, page) {
      const api = `${process.env.VUE_APP_PATH}/api/${process.env.VUE_APP_CUSTOMPATH}/admin/products?page=${page}`
    ...
    updatedProduct (context) {
      let url = `${process.env.VUE_APP_PATH}/api/${process.env.VUE_APP_CUSTOMPATH}/admin/product`
      let httpMethod = 'post'
      if (!context.state.isNew) {
        url = `${process.env.VUE_APP_PATH}/api/${process.env.VUE_APP_CUSTOMPATH}/admin/product/${context.state.tempProduct.id}`
        httpMethod = 'put'
      }
    ...
    deleteProduct (context, productId) {
      const url = `${process.env.VUE_APP_PATH}/api/${process.env.VUE_APP_CUSTOMPATH}/admin/product/${productId}`
    ...
    uploadFile (context, uploadedFile) {
      ...
      const url = `${process.env.VUE_APP_PATH}/api/${process.env.VUE_APP_CUSTOMPATH}/admin/upload`
